...
const Navbar = () => {
  ...
  return (
    <nav className="flex navbar items-center sm:h-[5.6rem] sm:w-screen sm:rounded-none  md:h-[7.2rem] md:w-[71.9rem] lg:h-[96rem] lg:w-[9.6rem]  sm:flex-row  md:flex-row  lg:flex-col sm:justify-between md:justify-between  lg:justify-center  lg:absolute bg-[#161d2f]  md:mt-[2.3rem]  lg:top-[3.2rem] lg:left-[3.2rem] md:rounded-3xl lg:rounded-3xl lg:translate-x-0">
      <NavLink to="/">
        <img
          src="/assets/logo.svg"
      ...
      <div className="avatar-wrap flex sm:flex-row md:flex-row lg:flex-col justify-center items-center gap-[2.4rem] ">
        {auth.isLoggedIn ? (
          ...
          <NavLink to="/login">
            <p className="text-[#5A698F] text-[1.3rem] text-light">Sign In</p>
          </NavLink>
        )}
